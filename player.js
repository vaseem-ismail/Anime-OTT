...
window.onload = function () {
    ...
    window.open(`http://video.fetch:5000/stream-video?filename=${encodeURIComponent(filename)}`);
    const videoURL = `http://video.fetch:5000/stream-video?filename=${encodeURIComponent(filename)}`;
